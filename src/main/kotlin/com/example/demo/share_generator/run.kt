...
fun main() {
    ...
    dtoVoGeneratorRun(kotlinPackageName = kotlinPackageName, kotlinGeneratorRootPath = kotlinGeneratorRootPath, dartCommonLib = dartCommonLib, dartShareEnumImport = dartShareEnumImport)
